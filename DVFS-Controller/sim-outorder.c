...
/*------------------------------cs203-----------------------------------*/
  ...
  opt_reg_int(odb, "-dvfs:interval", "size of Interval for dvfs simulator", &dvfsinterval, /* default */100000, /* print */TRUE, /* format */NULL);

  opt_reg_double(odb, "-dvfs:targetpower", "designed TargetPower for dvfs simualtor", &dvfstargetpower, /* default */71.7882, /* print */TRUE, /* format */NULL);
